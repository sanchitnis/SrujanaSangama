---
name: India Research Funding Landscape
description: Comprehensive funding knowledge base for REVA PhD scholars (CSE/CSA and interdisciplinary) — national government agencies, corporate fellowships, international bilateral schemes, and domain-specific portals.
version: "2.0"
tags: [funding, fellowships, grants, cse, csa, india, serb, dst, meity, anrf]
attribution: Content provided by PO 2026-06-01. Referenced by agents/scholar/grant-agent.md and workflows/08_grant-proposal.md (CONSTITUTION §10).
---

# India Research Funding Landscape
## Research Funding & Fellowship Knowledge Base v2.0
### REVA PhD Scholars — CSE / CSA and Interdisciplinary

> Referenced by: `agents/scholar/grant-agent.md`, `workflows/08_grant-proposal.md`
>
> **REVA University context:** Private university under REVA University Act 2012, UGC/AICTE recognised. Certain public sector grants require DSIR-SIRO recognition and/or NITI Aayog Darpan registration — see REVA Compliance Checklist below.

---

> ⚠️ **Verify deadlines annually**
>
> Grant call timelines change each year. Always verify current open calls, eligibility criteria, and deadlines directly on the agency portal before preparing a proposal. Agency URLs are provided for each scheme.
...
| IND-ANRF | SERB-SUPRA | 3 yrs (extendable) + high-end compute | High-risk / high-reward disruptive research | Covers high-end compute infrastructure; strong preliminary results required |
| IND-MEITY | Visvesvaraya PhD Scheme Phase II | FT: ₹38,750–₹43,750/month; RoR: 24% (Bengaluru X-class); Contingency: ₹1.2 L/yr; Int'l travel: ₹10.5 L one-time (from yr 3); PT: ₹3 L on completion | ESDM, AI, Big Data, Blockchain, Distributed Computing, Cybersecurity, Cloud | Institutional seat-allotment proposal required from School of CSE/CSA when MeitY opens call |
| IND-DST | INSPIRE Fellowship | ₹37,000–₹42,000/month + HRA + ₹20,000/yr contingency / 5 yrs | Multidisciplinary STEM, Data Sciences, Cognitive Science, IoT | Applicant must be PG 1st rank holder (M.Tech/M.Sc) OR valid GATE score at national cut-off |
...
|---|---|---|---|---|
| CORP-GOOGLE | Google PhD Fellowship | US$3,000/yr + Google Research Scientist mentorship | Algorithms, HCI, ML, NLP, Systems/Networking | Institutional nomination required from School Head |
...
| CORP-IBM | IBM PhD Fellowship Award | US$20,000 + IBM Cloud/Quantum access | Hybrid Cloud, Trustworthy AI, Quantum Computing | Competitive thesis track; institutional nomination required |
| CORP-TCS | TCS Research Fellowship | ₹37,000/month (4 yrs) + ₹2,500/month contingency + ₹2.5 L int'l travel | Software Engineering, Robotics, Conversational Systems, Data Analytics | Supervisor Q1 track record required |
...
|---|---|---|
| DSIR-SIRO Recognition | Valid SIRO certificate required for customs/GST exemptions on ANRF/DST equipment purchases | Verify with REVA Research Cell |
| NITI Aayog Darpan Portal ID | Required for civic-focused and public sector funding applications | Verify with REVA Admin |
| Host Institution Endorsement Letter | Registrar / Director of Research sign-off confirming lab space, power, compute clusters | Obtain per application |
| UGC/AICTE Recognition Current | Required for ANRF/SERB faculty PI applications | Maintained by REVA |
