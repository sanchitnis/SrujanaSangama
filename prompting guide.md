...
### 1. Be clear and specific
   ...
   - Provide context and details to help AI understand your needs.
...
### 2. Use examples
   ...
   - If you want a specific format or style, show AI an example.
   ...
   Why it's better: The good prompt provides a concrete example of the desired style and tone, giving AI a clear reference point for the new email.

### 3. Encourage thinking
   - For complex tasks, ask AI to "think step-by-step" or "explain your reasoning."
   ...
   Why it's better: The good prompt asks AI to think through the problem systematically, providing a guided structure for the response and asking for explanations of the reasoning process. It also prompts AI to create a summary at the end for easier reading.

### 4. Iterative refinement
   - If AI's first response isn't quite right, ask for clarifications or modifications.
   ...
   Why it's better: The good prompt provides specific feedback and clear instructions for improvements, allowing AI to make targeted adjustments instead of just relying on AI’s innate sense of what “better” might be — which is likely different from the user’s definition!

### 5. Leverage AI's knowledge
   - AI has broad knowledge across many fields. Don't hesitate to ask for explanations or background information
   - Be sure to include relevant context and details so that AI’s response is maximally targeted to be helpful
   ...
   Why it's better: The good prompt asks for specific, contextually relevant  information that leverages AI's broad knowledge base. It provides context for how the information will be used, which helps AI frame its answer in the most relevant way.

### 6. Use role-playing
   - Ask AI to adopt a specific role or perspective when responding.
   ...
   Why it's better: This prompt uses role-playing to explore multiple perspectives of the negotiation, providing a more comprehensive preparation. Role-playing also encourages AI to more readily adopt the nuances of specific perspectives, increasing the intelligence and performance of AI’s response.
...
1. **Specify your audience**
   ...
   Why it's better: The good prompt specifies the audience, desired tone, and key characteristics of the content, giving AI clear guidelines for creating appropriate and effective output.
...
3. **Ask for citations**
   - Request that AI cites specific parts of the document in its answers.
...
### Brainstorming
 1. Use AI to generate ideas by asking for a list of possibilities or alternatives.
     - Be specific about what topics you want AI to cover in its brainstorming
...
1. **Allow AI to acknowledge uncertainty**
   - Tell AI that it should say it doesn’t know if it doesn’t know. Ex. “If you're unsure about something, it's okay to admit it. Just say you don’t know.”

2. **Break down complex tasks**
   - If a task seems too large and AI is missing steps or not performing certain steps well, break it into smaller steps and work through them with AI one message at a time.

3. **Include all contextual information for new requests**
   - AI doesn't retain information from previous conversations, so include all necessary context in each new conversation.
...
Why it's better: This prompt combines multiple techniques including role assignment, specific task breakdown, structured output request, brainstorming (for campaign ideas and content themes), and asking for explanations. It provides clear guidelines while allowing room for AI's analysis and creativity.
