...
**Primary output**: A well-structured Markdown or HTML report saved to `/home/claude/` with filename `[Course-Code]_exam_review_[Date].md` (or `.html` if preferred for readability).
