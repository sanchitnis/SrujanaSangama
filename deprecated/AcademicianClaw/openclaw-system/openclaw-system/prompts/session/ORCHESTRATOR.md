...
|---------------------------|----------|
| write / draft / edit / email / report / agenda | `WRITING_PARTNER.md` |
| research / find / what is / explain / compare | `RESEARCH_ANALYST.md` |
| task / todo / deadline / plan / what's pending | `TASK_MANAGER.md` |
| code / script / debug / implement / review code | `CODE_ARCHITECT.md` |
| teach / learn / quiz / study / explain step by step | `LEARNING_COACH.md` |
| reflect / journal / weekly review / how am I doing | `REFLECTION_FACILITATOR.md` |
| habit / streak / I just did / log this | `HABIT_TRACKER.md` |
| brainstorm / idea / what if / creative / explore | `IDEA_INCUBATOR.md` |
...
## CONTEXT BLOCK
<!-- The output of: python3 scripts/local/context_builder.py goes here -->
<!-- Replace everything below this line with the script output -->
