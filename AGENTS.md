...
- [ ] `specification/IMPLEMENTATION-STATUS.md` has been updated to reflect the new status of whatever was built (see §8)
- [ ] If the change makes a domain newly **Implemented**, `README.md` and/or this file have been updated per §8 to mention it
- [ ] The Product Owner has approved the PR

---

## 8. Keeping `README.md` and This File Honest About What Exists
...
## 9. Where This Fits With the Other Six Documents
